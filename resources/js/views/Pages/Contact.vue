                ...
                <div class="flex flex-col w-full">
                    ...
                    <div class="flex justify-center">
                        <div class="mt-3 mb-10 p-5">
                            <a :href="'mailto:kafribung07@gmail.com'" target="_blank" class="font-light text-lg hover:underline hover:font-italic">kafribung07@gmail.com</a>
                            <div class="font-light text-lg mt-2">Mamuju Sulawesi Barat, Indonesia</div>
